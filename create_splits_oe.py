...
###Generate splits
os.makedirs('/home/b-evelyntong/hl/lincs_lvl3_oe/splits_4_7/', exist_ok=True)
nfolds = 2
for dataset_name in ['A375', 'A549', 'HA1E', 'HEK293T', 'HT29', 'MCF7', 'PC3', 'VCAP']:
	for splits_type in ['random']:
		splits_setting = '{}fold'.format(nfolds)
		outdir = '/home/b-evelyntong/hl/lincs_lvl3_oe/splits_4_7/{}/{}/{}/{}'.format('genetic', dataset_name, splits_type, splits_setting)
		base_path = "/home/b-evelyntong/hl/lincs_lvl3_oe/torch_geometric_4_7"
		try:
